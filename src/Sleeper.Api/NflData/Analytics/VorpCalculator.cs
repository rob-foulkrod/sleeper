...
public static class VorpCalculator
{
    ...
    /// </summary>
    public static Dictionary<string, decimal> EstimateReplacementLevels(int teams, Dictionary<string, int> starterSlots, int flexSlots = 0)
    {
        ...
        return new Dictionary<string, decimal>
        {
            ...
            ["RB"] = EstimateReplacement(teams * (starterSlots.GetValueOrDefault("RB", 2) + flexSlots), PositionDepthCurves.Rb),
            ["WR"] = EstimateReplacement(teams * (starterSlots.GetValueOrDefault("WR", 2) + flexSlots), PositionDepthCurves.Wr),
            ["TE"] = EstimateReplacement(teams * (starterSlots.GetValueOrDefault("TE", 1) + flexSlots), PositionDepthCurves.Te),
